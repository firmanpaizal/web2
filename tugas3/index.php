...
<table class="table table-striped table-hover">
	...
	echo  '<td>
			<a href="edit.php?nim='.$row['nim'].'" title="Edit Data" >Edit</a>
			<a href="index.php?aksi=delete&nim='.$row['nim'].'" title="Hapus Data" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama'].'?\')" >Delete</a></td>
		</tr>';
		$no++;
		}
	}
...
?>                 
	...
	<footer>Firman paizal - 14.111.034</footer>
</body>
</html>';
